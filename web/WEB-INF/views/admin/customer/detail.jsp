<%@page contentType="text/html" pageEncoding="UTF-8" %>
    <%@taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        <%@taglib prefix="t" tagdir="/WEB-INF/tags/" %>
            ...
            <t:layout title="Customer Detail: ${customer.name}">
                <jsp:attribute name="actions">
                    <div class="d-flex gap-3">
                        ...
                        <t:link url="${pageContext.request.contextPath}/admin/customer/update?id=${customer.customerId}"
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Customer Code</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">${customer.code}</div>
                                        </div>
                                        <div class="col-auto">
                    ...
                    <div class="card shadow-sm mb-4 border-0">
                        ...
                        <div class="card-body">
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9 fs-5 fw-bold text-dark">${customer.name}</div>
                            </div>
                            <hr class="bg-light">
                            <div class="row mb-3">
                                <div class="col-sm-3 text-muted small text-uppercase fw-bold">Email Address</div>
                                <div class="col-sm-9 text-primary">${empty customer.email ? 'N/A' : customer.email}
                                </div>
                            </div>
                            <hr class="bg-light">
                            <div class="row mb-3">
                                <div class="col-sm-3 text-muted small text-uppercase fw-bold">Phone Number</div>
                                <div class="col-sm-9">${empty customer.phone ? 'N/A' : customer.phone}</div>
                            </div>
                            <hr class="bg-light">
                            <div class="row mb-0">
                                <div class="col-sm-3 text-muted small text-uppercase fw-bold">Address</div>
                                <div class="col-sm-9">${empty customer.address ? 'N/A' : customer.address}</div>
                            </div>
                        </div>
                    </div>
