      ...
      <div class="row">
        <div class="col-12 col-md-8 col-lg-6 mx-auto">
          <div class="d-flex justify-content-between align-items-center mb-4">
            <h1 class="h3 mb-0">
              <i class="bi bi-shield-lock me-2"></i>Cập nhật Permission
            </h1>
          ...
          <div class="card shadow-sm">
            <div class="card-body">
              <form method="POST" action="${pageContext.request.contextPath}/admin/permission/update">
                ...
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control" id="code" name="code" required 
                         value="${permission.code}" placeholder="Ví dụ: USER_VIEW, PRODUCT_CREATE">
                ...
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control" id="name" name="name" required 
                         value="${permission.name}" placeholder="Ví dụ: Xem người dùng, Tạo sản phẩm">
                </div>
