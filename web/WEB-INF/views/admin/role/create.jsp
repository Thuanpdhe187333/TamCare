...
<t:layout title="Create Role">
    ...
    <jsp:body>
        <div class="card shadow-sm">
            <div class="card-body">
                <form method="POST" action="${pageContext.request.contextPath}/admin/role/create" class="m-0">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="name" name="name" required 
                               placeholder="Example: ADMIN, WAREHOUSE_MANAGER">
                    </div>

                    <div class="mb-3">
                        <label for="description" class="form-label">Description</label>
                        <textarea class="form-control" id="description" name="description" rows="3" 
                                  placeholder="Role responsibilities and access level"></textarea>
                    </div>
