...
<body>
    ...
    <div class="container">
        ...
        <div class="noti-list">
            <div class="noti-card unread emergency">
                <div class="noti-icon"><i class="fa-solid fa-triangle-exclamation"></i></div>
                <div class="noti-info">
                    <h4>Cảnh báo sức khỏe khẩn cấp!</h4>
                    <p>Huyết áp của <b>Ông Nguyễn Văn A</b> đã vượt ngưỡng an toàn (160/95 mmHg). Vui lòng kiểm tra ngay.</p>
                    <span class="noti-time"><i class="fa-regular fa-clock"></i> 10 phút trước</span>
                </div>
            </div>
            ...
            <div class="noti-card unread">
                ...
                <div class="noti-info">
                    <h4>Điểm danh thành công</h4>
                    <p><b>Bà Trần Thị B</b> đã hoàn thành điểm danh sức khỏe buổi trưa và uống thuốc đúng hạn.</p>
                    <span class="noti-time"><i class="fa-regular fa-clock"></i> 2 giờ trước</span>
                </div>
            </div>

            <div class="noti-card">
                <div class="noti-icon"><i class="fa-solid fa-gift"></i></div>
                <div class="noti-info">
                    <h4>Chúc mừng! Bạn nhận được Bonus</h4>
                    <p>Đơn hàng thiết bị y tế của bạn đã hoàn thành. Bạn được cộng <b>+500 pts</b> vào tài khoản.</p>
                    <span class="noti-time"><i class="fa-regular fa-clock"></i> Hôm qua</span>
                </div>
            </div>
        </div>
        
        <div style="text-align: center; margin-top: 40px;">
            <button style="background: none; border: none; color: #94a3b8; cursor: pointer; text-decoration: underline;">
